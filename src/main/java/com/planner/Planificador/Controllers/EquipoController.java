...
public class EquipoController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<EquipoDto> getEquipo(@AuthenticationPrincipal UsuarioToken usuarioToken) {

		return ResponseEntity.ok(equipoService.getEquipo(usuarioToken.getId()));
